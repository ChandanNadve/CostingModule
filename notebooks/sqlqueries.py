...
pkg_bom_detail_query='''select bompackmaterialhrdid,bompackmaterialdtlid,matcode,matdesc,unitst,qtyco,qtycon 
...
bom_labcost_dtl_query=''' select bd.bom_labcost_dtlid ,bom_labcost_hdrid,bd.laborcategory,bd.rate
...
bomdespatchdtl_query=''' select bomdespatchdtlid,bomdespatchhdrid,itemname,itemcode,qty
...
bomcoatingdtl_query=''' select bomcoatingdtlid,bomcoatinghdrid,coatingitemname,coatingitemcode,coatqty
from bomcoatingdtl'''
...
bomcolorsdtl_query=''' select bomcolorsdtlid,bomcolorshdrid,matcode,matdesc,qtyco
from bomcolorsdtl '''
...
screendtl_query="""select bomcolorshdr_scrid,bomcolorsdtl_scrid,matcode,qtyco
from bomcolorsdtl_scr """

# 25. Selected Items for Costing Query
selecteditem_query= ''' select fgitemcode,fgitemname,processcostingdtlid 
...
##FG wise Labor BOM Data Query
lab_bom_data= '''
select bompackmaterialhrdid,bom_lobor_dtlid,laborcategory,nooflabors 
from bom_lobor_dtl
'''